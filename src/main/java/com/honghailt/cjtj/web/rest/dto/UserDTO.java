package com.honghailt.cjtj.web.rest.dto;
...
public class UserDTO {
    ...
    private boolean operateAccount;
    ...
    public UserDTO(String login, List<String> authAccounts, boolean isSellerLogin) {
        this.login = login;
        this.authAccounts = authAccounts;
        this.isSellerLogin = isSellerLogin;
    }

    public UserDTO(User user, String login, List<String> authAccounts, boolean isSellerLogin, boolean operateAccount) {
        this(user.getId(),login,user.getNick(),authAccounts,user.getPhone(),user.getAdgroupCount(),
            user.getAutoAdgroupNum(),user.getAutoPlanNum(),user.getAutoLongPlanNum(),
            user.getAutoKeyAdgroupNum(),
            user.getAutoLongAdgroupNum(),user.getAutoWirelessAdgroupNum(),user.getAutoActivityAdgroupNum(),
            user.getAutoAdgroupCount(),user.getWangWang(),
            user.getVersion(), VersionUtils.getVersionName(user.getVersion()),
            user.getExpiresDay(),isSellerLogin,operateAccount);
    }

    public UserDTO(Long id, String login, String nick, List<String> authAccounts, String phone,
                   Long adgroupCount, Long autoAdgroupNum, Long autoPlanNum, Long autoLongPlanNum,
                   Long autoKeyAdgroupNum, Long autoLongAdgroupNum, Long autoWirelessAdgroupNum,
                   Long autoActivityAdgroupNum, Long autoAdgroupCount, String wangWang, Version version,
                   String versionName, Instant expiresDay, boolean isSellerLogin, boolean operateAccount) {
        this.id = id;
        this.login = login;
        this.nick = nick;
        this.authAccounts = authAccounts;
