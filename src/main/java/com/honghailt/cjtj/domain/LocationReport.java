 ...
 * @Author: WujinXian
 * @Description:
 * @Date: Created in 17:21 2019/5/17
 * @Modified By
 */
public class LocationReport extends AbstractReport {
    ...
    public LocationReport( FeedflowItemAdzoneRptdailylistResponse.RptResultDto rptResultDto) {
